...
public class Vader : MonoBehaviour
{
    ...
    public int redKyberCrystalsCollected = 0;
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        else if (collision.gameObject.CompareTag("ObjectCollectiblePurple") || collision.gameObject.CompareTag("ObjectCollectibleRed"))
        {
            if (SoundManager.Instance != null)
            {
            ...
            if (collision.gameObject.CompareTag("ObjectCollectiblePurple"))
            {
                purpleKyberCrystalsCollected++;
            }
            else if (collision.gameObject.CompareTag("ObjectCollectibleRed"))
            {
                redKyberCrystalsCollected++;
            }

            Destroy(collision.gameObject);
        }
        else if (collision.gameObject.CompareTag("HazardGreen") || collision.gameObject.CompareTag("HazardBlue"))
        {
    ...
    void ShowGameOver()
    {
        ...
        {
            Debug.LogError("Vader: SceneManage.Instance is null when trying to load GameOver");
        }
